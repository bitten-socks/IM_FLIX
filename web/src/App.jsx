  ...
  return (
    <div className="min-h-screen bg-[#0b0c0f] text-white">
      ...
      <main className="mx-auto flex max-w-2xl flex-col gap-4 px-6 py-10">
        <div className="relative overflow-hidden rounded-3xl bg-[#ece5d6] p-10">
          <div className="mb-6 text-center">
            <p className="text-xs uppercase tracking-wider text-stone-500">MY DEVICE</p>
            <h1 className="text-lg font-bold text-stone-900">{connected ? product.name : 'FLIX'}</h1>
          </div>

          <KeypadHero />

          {!connected && (
            <div className="absolute inset-0 flex flex-col items-center justify-center gap-4 bg-[#ece5d6]/85 backdrop-blur-sm">
              <p className="text-sm text-stone-500">FLIX 기기가 연결되어 있지 않습니다</p>
              <button
                onClick={connect}
